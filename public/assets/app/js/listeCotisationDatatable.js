        ...
        e = $(".m-datatable").mDatatable({
            ...
            columns: [{field: "DepositPaid", type: "number"}, {
                ...
                field: "Status", title: "Status", template: function (e) {
                    var t = {
                        1: {title: "Payé", class: " m-badge--success"},
                        2: {title: "Non payé", class: " m-badge--danger"},
                        3: {title: "Partiel", class: " m-badge--warning"},
                        4: {title: "Success", class: ""},
                        5: {title: "Info", class: " m-badge--info"},
                        6: {title: "", class: ""},
                        7: {title: "Partiel", class: ""}
                    };
